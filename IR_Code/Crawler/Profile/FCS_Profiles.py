...
language = 'English'
Profile = 0
session.get("https://pureportal.coventry.ac.uk/en/organisations/ics-research-centre-for-fluid-and-complex-systems-fcs/persons/")
time.sleep(10)
session.find_element(By.XPATH,"//button[@id='onetrust-accept-btn-handler']").click()
for j in range(0 , 1):
        urls = []
        base_url = "https://pureportal.coventry.ac.uk/en/organisations/ics-research-centre-for-fluid-and-complex-systems-fcs/persons/?page=%d"%(j)
