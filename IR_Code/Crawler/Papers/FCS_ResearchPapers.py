...
session.get("https://pureportal.coventry.ac.uk/en/organisations/ics-research-centre-for-fluid-and-complex-systems-fcs/persons/")    # Coventry URL Site
time.sleep(10)
...
for j in range(0 , 1):
        ...
        # Profiles per Page
        Cov_Page_Url = "https://pureportal.coventry.ac.uk/en/organisations/ics-research-centre-for-fluid-and-complex-systems-fcs/persons/?page=%d"%(j)
